-- 0001_init: the whole schema as of the first migration.
-- Identical content to packages/db/schema.sql. Later migrations amend the
-- schema file in place and add a numbered file here.
